...
<section id="team" class="front-page-section">
	...
	<?php endif; ?>
	<div class="select-left"> <button class="btn btn-link team-select"  ><i class="fa fa fa-angle-left"></i></button> </div>
	...
	<div class="select-right"> <button class="btn btn-link team-select" ><i class="fa fa fa-angle-right"></i></button> </div>
