jQuery( document ).ready( function( $ ) {
  ...
  var t=0;
  $(".widget_illdy_person").hide();
  $(".widget_illdy_person").eq(t).show();
  $(".widget_illdy_person").eq(t+1).show();
  $(".widget_illdy_person").eq(t+2).show();

  $( ".select-left" ).click(function() {
  //  alert( "Handler for .click() called." );
    if(t>0){
      $(".widget_illdy_person").eq(t+2).hide();
      t--;
      $(".widget_illdy_person").eq(t).show("slow");
    }
   // console.log(t);
  });
  ...
  $( ".select-right" ).click(function() {
   // alert( "Handler for .click() called." );
    if( t+3 < $(".widget_illdy_person").length ){
      $(".widget_illdy_person").eq(t).hide();
      t++;
      $(".widget_illdy_person").eq(t+2).show("slow");
    }
    //console.log(t);
  });
